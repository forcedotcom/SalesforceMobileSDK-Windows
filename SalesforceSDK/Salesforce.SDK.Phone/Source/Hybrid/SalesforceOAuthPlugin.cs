...
namespace Salesforce.SDK.Hybrid
{
    ...
    /// </summary>
    public class SalesforceOAuthPlugin : BaseCommand
    {
        /// <summary>
        ...
        {
            JSONCredentials credentials = PhoneHybridMainPage.GetInstance().GetJSONCredentials();
            if (credentials == null)
            {
        ...
        {
            String appHomeUrl = PhoneHybridMainPage.GetInstance().GetAppHomeUrl();
        ...
        {
            PhoneHybridMainPage.GetInstance().LogoutCurrentUser();
