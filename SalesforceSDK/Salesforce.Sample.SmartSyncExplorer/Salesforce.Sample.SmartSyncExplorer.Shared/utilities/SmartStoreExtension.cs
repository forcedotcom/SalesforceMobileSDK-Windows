...
namespace Salesforce.Sample.SmartSyncExplorer.utilities
{
    public class SmartStoreExtension
    {
        ...
        public readonly IndexSpec[] AccountsIndexSpecs =
        {
        ...
        public readonly IndexSpec[] OpportunitiesIndexSpecs =
        {
            new IndexSpec("Name", SmartStoreType.SmartString),
            new IndexSpec("Id", SmartStoreType.SmartString),
        ...
        public void InsertAccounts(JArray accounts)
        {
            ...
            {
                foreach (JObject account in accounts.Values<JObject>())
                {
        ...
        public void InsertOpportunities(JArray opportunities)
        {
            ...
            {
                foreach (JObject opportunity in opportunities.Values<JObject>())
                {
